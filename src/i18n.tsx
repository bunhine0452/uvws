...
const translations: Record<Lang, Record<string, string>> = {
  ko: {
    ...
    checking_updates: "확인 중…",
    updates_title: "업데이트",
    updates_available: "{n}개 업데이트 가능",
    up_to_date: "최신 상태입니다 ✅",
    upgrade: "업그레이드",
    upgrade_all: "전체 업그레이드",
    upgrading: "업그레이드 중…",
    col_current: "현재",
    col_latest: "최신",
    // Git tab
    ...
    later: "나중에",
    updating: "업데이트 중…",
    update_no_notes: "이번 버전의 변경 내용이 제공되지 않았습니다.",
  ...
  en: {
    ...
    later: "Later",
    updating: "Updating…",
    update_no_notes: "No release notes were provided for this version.",
