...
const translations: Record<Lang, Record<string, string>> = {
  ko: {
    ...
    browse: "찾아보기…",
    // Python version (uv) — note: python_version key already exists (setup modal)
    python_version_desc: "이 프로젝트에 사용할 Python 버전을 고르세요",
    python_version_hint: "선택하면 .python-version에 고정됩니다. 미설치 버전은 uv가 자동으로 설치합니다.",
    pinned_to: "{v} 고정됨",
    py_installed: "설치됨 ({v}) — 선택 시 고정",
    py_not_installed: "미설치 — 선택 시 설치 후 고정",
    py_loading: "Python 버전 불러오는 중…",
    py_versions_unavailable: "버전 목록을 불러올 수 없습니다 (uv 확인)",
    // Env tab
    env_vars: "환경변수",
    ...
    theme_light: "라이트",
    theme_dark: "다크",
    settings_window_opacity: "창 투명도",
    settings_glass_strength: "UI 글래스 강도",
    ...
    // uv setup gate + onboarding
    uv_required_title: "uv가 필요합니다",
    uv_required_desc: "uvws는 Astral의 초고속 패키지 매니저 uv로 Python 프로젝트를 실행합니다. 버튼 한 번으로 설치하세요.",
    uv_install_btn: "uv 자동 설치",
    uv_installing: "uv 설치 중…",
    uv_install_failed: "설치를 확인하지 못했습니다. 아래 명령으로 수동 설치 후 다시 확인하세요.",
    uv_manual_hint: "또는 터미널에서 직접:",
    uv_recheck: "다시 확인",
    uv_continue_anyway: "일단 계속",
    uv_docs: "uv 문서 열기",
    uv_installed: "uv {v} 설치됨",
    empty_add_first: "+ 첫 프로젝트 추가",
    empty_examples: "ComfyUI · Stable Diffusion · FastAPI · Streamlit · Gradio — 폴더만 등록하면 원클릭 실행",
    ...
    failed_open_folder: "폴더 열기 실패: {err}",
  ...
  en: {
    ...
    browse: "Browse…",
    // Python version (uv) — note: python_version key already exists (setup modal)
    python_version_desc: "Choose the Python version for this project",
    python_version_hint: "Selecting pins it to .python-version. Missing versions are installed automatically by uv.",
    pinned_to: "Pinned: {v}",
    py_installed: "Installed ({v}) — click to pin",
    py_not_installed: "Not installed — installs, then pins",
    py_loading: "Loading Python versions…",
    py_versions_unavailable: "Couldn't load versions (check uv)",
    ...
    settings_glass_strength: "UI glass strength",
    ...
    // uv setup gate + onboarding
    uv_required_title: "uv is required",
    uv_required_desc: "uvws runs your Python projects with uv, Astral's ultra-fast package manager. Install it in one click.",
    uv_install_btn: "Install uv automatically",
    uv_installing: "Installing uv…",
    uv_install_failed: "Couldn't verify the install. Install manually with the command below, then re-check.",
    uv_manual_hint: "Or do it yourself in a terminal:",
    uv_recheck: "Re-check",
    uv_continue_anyway: "Continue anyway",
    uv_docs: "Open uv docs",
    uv_installed: "uv {v} installed",
    empty_add_first: "+ Add your first project",
    empty_examples: "ComfyUI · Stable Diffusion · FastAPI · Streamlit · Gradio — register a folder, launch in one click",
    ...
    failed_open_folder: "Failed to open folder: {err}",
